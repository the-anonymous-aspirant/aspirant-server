...
func newRelHandlerDB(t *testing.T) (*gorm.DB, string, uint) {
	...
	db.AutoMigrate(&data_models.Room{}, &data_models.RoomMember{}, &data_models.RelationshipType{}, &data_models.Relationship{}, &data_models.RelationshipAction{}, &data_models.RelationshipEvent{})
